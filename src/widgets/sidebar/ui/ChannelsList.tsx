    ...
    <div className="space-y-1">
      {channels.map((channel) => {
        const avatarUrl = channel.avatar
          ? getAvatarUrl(channel.id, channel.avatar)
          : '';
        ...
        return (
          ...
          >
            ...
            >
              {avatarUrl ? (
                <>
                  ...
                  />
                  <div className="absolute inset-0 bg-gray-100 dark:bg-gray-800 flex items-center justify-center transition-opacity duration-300 -z-10">
                    <svg
                      className={`w-4 h-4 ${
                        currentChannel === channel.username
                          ? 'text-white/40'
            ...
            <button
              onClick={(e) => onUnsubscribe(e, channel)}
